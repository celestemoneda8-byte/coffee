...
<header>
  <nav class="navbar navbar-expand-lg" style="background: #eacdb9; padding: 10px 20px;">
    <div class="container-fluid">

      <a class="navbar-brand navbar-brand-custom d-flex align-items-center gap-2" href="index.php">
        <img src="../images/expresso-logo.png" alt="Expresso Logo" style="height: 50px; width: auto;">
        <span style="font-weight: 700; color: #3e2723; font-size: 1.3rem;">EXpresso Caffe</span>
      </a>
