    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-2">
          ...
          <li class="nav-item"><a class="nav-btn btn" href="#contact">About Us</a></li>
          <li class="nav-item"><a class="nav-btn btn" href="#contact">Contact</a></li>
        </ul>
...
<div id="homeCarousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <!-- FIRST SLIDE (Logo + tagline + button side by side) -->
    <div class="carousel-item active">
      <img src="../images/expresso-background.jpg" class="d-block w-100" style="height: 93vh; object-fit: cover;">

      <div class="carousel-caption d-flex align-items-center justify-content-center gap-4"
           style="top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; width: 90%;">

        <img src="../images/expresso-logo.png" class="home-img" style="width: 150px; height: auto;">

        <p class="home-tagline mb-0" style="font-size: 1.2rem; max-width: 300px;">
