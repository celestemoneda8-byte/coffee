<<<<<<< HEAD:.history/AdminSide/includes/admin-login_20251217013100.php
<?php
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $password === '') {
        ...
        if ($username === FIXED_ADMIN_USER && $password === FIXED_ADMIN_PASS) {
            ...
            header('Location: /EXpresso/coffee/AdminSide/pages/dashboard.php');
            exit;
        }
...
>>>>>>> 48c3441730d7f3bcc0f52162c85c9984cc42607c:AdminSide/admin-login.php
</html>