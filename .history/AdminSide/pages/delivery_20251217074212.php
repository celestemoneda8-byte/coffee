...
if ($dbMode) {
    $sql = "SELECT o.order_id AS id, 
                   COALESCE(o.customer_name, 'Guest') AS customer, 
    ...
    $res = @$conn->query("SELECT COUNT(*) AS cnt FROM orders WHERE COALESCE(status, LOWER(order_status)) IN ('pending', 'preparing', 'ready')");
    if ($res) {
        $row = $res->fetch_assoc();
  ...
  <div class="d-flex min-vh-100">
    ...
    <main class="flex-fill p-4">
      <div class="container-fluid">
        ...
        <?php $pageTitle = 'Delivery Management'; include 'header.php'; ?>
