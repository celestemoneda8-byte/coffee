  ...
  <div class="d-flex min-vh-100">
    ...
    <div class="row g-4 mt-2">
      <div class="col-12 col-lg-7">
        <div class="card p-4">
          <h6 class="mb-3 fw-semibold"><i class="bi bi-bar-chart-fill me-2"></i>Revenue (Last 7 Days)</h6>
      ...
      <div class="col-12 col-lg-5">
        <div class="card p-4">
          <h6 class="mb-3 fw-semibold"><i class="bi bi-pie-chart-fill me-2"></i>Overview Breakdown</h6>
