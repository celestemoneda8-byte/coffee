  ...
  <div class="d-flex min-vh-100">
    ...
    <div class="row g-3 mb-4">
      <div class="col-12 col-md-6 col-lg-3">
        <div class="card p-4 border-0 shadow-sm h-100" style="border-left: 4px solid #e79a45 !important;">
          <div class="d-flex align-items-center">
            <div class="rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(231, 154, 69, 0.15);">
              <i class="bi bi-cart-fill fs-4" style="color: #e79a45;"></i>
            </div>
            <div>
              <div class="text-muted small">Total Orders</div>
              <div class="fs-3 fw-bold" style="color: var(--theme-primary);"><?php echo (int)$kpi['total_orders']; ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div class="card p-4 border-0 shadow-sm h-100" style="border-left: 4px solid #f6c94d !important;">
          <div class="d-flex align-items-center">
            <div class="rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(246, 201, 77, 0.15);">
              <i class="bi bi-clock-fill fs-4" style="color: #f6c94d;"></i>
            </div>
            <div>
              <div class="text-muted small">Pending Orders</div>
              <div class="fs-3 fw-bold" style="color: var(--theme-primary);"><?php echo (int)$kpi['pending_orders']; ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div class="card p-4 border-0 shadow-sm h-100" style="border-left: 4px solid #66bb6a !important;">
          <div class="d-flex align-items-center">
            <div class="rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(102, 187, 106, 0.15);">
              <i class="bi bi-people-fill fs-4" style="color: #66bb6a;"></i>
            </div>
            <div>
              <div class="text-muted small">Total Customers</div>
              <div class="fs-3 fw-bold" style="color: var(--theme-primary);"><?php echo (int)$kpi['total_customers']; ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div class="card p-4 border-0 shadow-sm h-100" style="border-left: 4px solid var(--theme-primary, #3e2723) !important;">
          <div class="d-flex align-items-center">
            <div class="rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(62, 39, 35, 0.12);">
              <i class="bi bi-cash-stack fs-4" style="color: var(--theme-primary);"></i>
            </div>
            <div>
              <div class="text-muted small">Total Sales</div>
              <div class="fs-3 fw-bold" style="color: var(--theme-primary);"><?php echo htmlspecialchars(format_currency($kpi['total_sales'])); ?></div>
            </div>
          </div>
        </div>
      </div>
