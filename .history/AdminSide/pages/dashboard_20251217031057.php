...
<body class="page-bg">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      // Chart data from PHP
      const CHART_REV_LABELS = <?php echo json_encode($chartRevLabels); ?>;
      const CHART_REV_DATA = <?php echo json_encode($chartRevData); ?>;
      const CHART_KPI_LABELS = <?php echo json_encode($chartKpiLabels); ?>;
      const CHART_KPI_DATA = <?php echo json_encode($chartKpiData); ?>;

      console.log('Chart data loaded:', { CHART_REV_LABELS, CHART_REV_DATA, CHART_KPI_LABELS, CHART_KPI_DATA });
      ...
      // KPI Doughnut Chart
      const doughnutCtx = document.getElementById('kpiDoughnut');
      if (doughnutCtx) {
