...
<head>
    ...
    <style id="dynamicTheme">
        :root {
            --admin-primary: <?php echo htmlspecialchars($settings['admin_primary_color'] ?? '#3e2723'); ?>;
            --admin-secondary: <?php echo htmlspecialchars($settings['admin_secondary_color'] ?? '#5d4037'); ?>;
            --admin-accent: <?php echo htmlspecialchars($settings['admin_accent_color'] ?? '#d4a574'); ?>;
            --theme-primary: <?php echo htmlspecialchars($settings['admin_primary_color'] ?? '#3e2723'); ?>;
            --theme-secondary: <?php echo htmlspecialchars($settings['admin_secondary_color'] ?? '#5d4037'); ?>;
            --theme-accent: <?php echo htmlspecialchars($settings['admin_accent_color'] ?? '#d4a574'); ?>;
...
<body>
    <div class="d-flex min-vh-100">
      ...
      <main class="flex-fill p-4">
        <div class="container-fluid">
          ...
          <?php $pageTitle = 'Settings'; include 'header.php'; ?>
    ...
    <script>
        ...
        let settingsData = {
            ...
            admin_primary_color: '<?php echo htmlspecialchars($settings['admin_primary_color'] ?? '#3e2723'); ?>',
            admin_secondary_color: '<?php echo htmlspecialchars($settings['admin_secondary_color'] ?? '#5d4037'); ?>',
            admin_accent_color: '<?php echo htmlspecialchars($settings['admin_accent_color'] ?? '#d4a574'); ?>',
            customer_primary_color: '<?php echo htmlspecialchars($settings['customer_primary_color'] ?? '#3e2723'); ?>',
            customer_secondary_color: '<?php echo htmlspecialchars($settings['customer_secondary_color'] ?? '#5d4037'); ?>',
            customer_accent_color: '<?php echo htmlspecialchars($settings['customer_accent_color'] ?? '#d4a574'); ?>',
            rider_primary_color: '<?php echo htmlspecialchars($settings['rider_primary_color'] ?? '#3e2723'); ?>',
            rider_secondary_color: '<?php echo htmlspecialchars($settings['rider_secondary_color'] ?? '#5d4037'); ?>',
            rider_accent_color: '<?php echo htmlspecialchars($settings['rider_accent_color'] ?? '#d4a574'); ?>'
        };
        ...
        document.getElementById('restoreBtn').addEventListener('click', function() {
            ...
            const defaultSettings = {
                ...
                admin_primary_color: '#3e2723',
                admin_secondary_color: '#5d4037',
                admin_accent_color: '#d4a574',
                customer_primary_color: '#3e2723',
                customer_secondary_color: '#5d4037',
                customer_accent_color: '#d4a574',
                rider_primary_color: '#3e2723',
                rider_secondary_color: '#5d4037',
                rider_accent_color: '#d4a574'
            };
