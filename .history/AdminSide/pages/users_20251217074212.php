...
// Fetch Admin Users
$users = [];
$sql = "SELECT id, username, user_type, created_at, status FROM users ORDER BY user_type ASC, created_at DESC";
  ...
  <div class="d-flex min-vh-100">
    ...
    <main class="flex-fill p-4">
      <div class="container-fluid">
        ...
        <?php $pageTitle = 'Users'; include 'header.php'; ?>
                  ...
                  <tr>
                    ...
                    <td class="text-end pe-4">
                        <div class="btn-group btn-group-sm">
                            ...
                            <form method="POST" action="users_actions.php" class="d-inline" 
